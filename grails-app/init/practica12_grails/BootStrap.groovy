...
//        new User(username: "admin", name: "Juanito", lastName: "Rodríguez", password: "admin1234").save(failOnError: true)
        ...
        def administration_department = new Department(name: 'Administration', byUser: 'admin').save(failOnError: true)
        def ti_department = new Department(name: 'Information Technology', byUser: 'admin').save(failOnError:true)
        ...
        def category = new Category(name: 'Business', byUser: admin.username).save(failOnError: true)
        ...
        def test_contact = new Contact(name: 'Carlos', lastName: 'Pérez Ureña', email: 'carlosperezurena@gmail.com', phone: '8097247726', address: 'Calle 7, #292, Urb. Don José María, Llanos de Gurabo, Santiago',
                work_position: 'Chief', mobile: '8298742286', category: category,
